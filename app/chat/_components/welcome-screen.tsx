...
export function WelcomeScreen({ onPromptClick }: WelcomeScreenProps) {
  return (
    <div className="flex flex-col items-center justify-center h-full text-center py-8 sm:py-12 px-4">
      ...
      {/* Title */}
      <h2 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-zinc-100 mb-2">
        {UI_TEXT.welcomeTitle}
      </h2>

      {/* Subtitle */}
      <p className="text-sm sm:text-base text-gray-500 dark:text-zinc-400 max-w-xs sm:max-w-md mb-4 sm:mb-6">
